...
{String aux = tercetosIncompletos.pop();tercetos.get(conversionIndexStoI(aux)).setT3(((Integer)tercetos.size()).toString()); agregarTerceto("ETIQUETA","",";etiqueta"+ (tercetos.size()));  Integer lastRef = TablaDeSimbolos.getContexto(val_peek(2).sval).popRef(); estructuras.add("Linea "+lastRef.toString() +": "+"IF");}
break;
case 104:
...
{String aux = tercetosIncompletos.pop();tercetos.get(conversionIndexStoI(aux)).setT3(((Integer)tercetos.size()).toString()); agregarTerceto("ETIQUETA","",";etiqueta"+ (tercetos.size())); Integer lastRef = TablaDeSimbolos.getContexto(val_peek(4).sval).popRef(); estructuras.add("Linea "+lastRef.toString() +": "+"IF");}
break;
case 107:
...
{String incompleto = agregarTerceto("BI", "", "");String aux = tercetosIncompletos.pop();tercetos.get(conversionIndexStoI(aux)).setT3(((Integer)tercetos.size()).toString()); agregarTerceto("ETIQUETA","",";etiqueta"+ (tercetos.size())); tercetosIncompletos.add(incompleto);}
break;
case 121:
